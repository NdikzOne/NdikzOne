<h1 align="center">Hi, I'm Andika Candra Prasetya <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>

<details>
<summary>⚡ Kumpulan Website Saya</summary>
...
- 👤 Nama : Andika Candra Prasetya
- 📍 Lokasi : Demak, Central Java, Indonesia 🇮🇩
- 🚀 Proyek Saat Ini : [Website Anime](https://ndifora.vercel.app)
...
`HTML` `CSS` `JavaScript` `React` `Laravel` `PHP` `REST API` `Git` `GitHub` `Docker`
...
### 🎬 Anime Website
Website streaming dan informasi anime, dibuat sebagai proyek pembelajaran.
